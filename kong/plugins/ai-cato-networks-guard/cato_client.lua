-- Cato Networks AI firewall client (REST + shared header construction).
--
...
-- Convert a {k = v} header map to the array-of-strings form some clients
-- (e.g. the WebSocket handshake) expect.
...
-- Build the firewall URLs from the configured api_base.
